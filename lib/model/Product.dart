...
class Product {
  ...
  String get formattedPrice => 'Rp ${price.toString().replaceAllMapped(RegExp(r'(\d)(?=(\d{3})+(?!\d))'), (Match m) => '${m[1]}.')}';

  // Helper untuk status stok
  String get stockStatus => stock > 0 ? 'Tersedia: $stock' : 'Stok Habis';
  
  // Perbaikan tipe data Color ditambahkan agar tidak squiggly biru
